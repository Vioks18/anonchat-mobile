...
- deps.unused (P2) — package.json: unused: @types/lodash, expo, expo-background-fetch, expo-blur, expo-build-properties... **NEW**
- bigfile.max_lines (P1) — app/**/*.{ts,tsx,js,jsx}: files too large: File exceeds max lines (323 > 300): app\components\ChatCore.tsx, File exceeds max lines (541 > 300): app\screens\ChatListScreen.tsx, File exceeds max lines (521 > 300): app\screens\ProfileScreen.tsx... **NEW**
